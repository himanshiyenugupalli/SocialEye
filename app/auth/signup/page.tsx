    ...
    <main className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <div className="hidden md:flex flex-col items-center justify-center p-12 bg-white/10 dark:bg-black/10 border-r border-white/20">
          ...
          <h2 className="mt-8 text-2xl font-bold text-center">Join SocialEye</h2>
          <p className="text-slate-mid text-center mt-2">Become part of a movement solving local civic issues together.</p>
        </div>
        ...
        <div className="p-8 sm:p-12">
          ...
          <h2 className="text-3xl font-bold text-slate-text mb-6">Sign Up</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1 relative">
              ...
              <p className="text-xs text-slate-mid mt-1">Must be at least 6 characters.</p>
            </div>

            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 mt-6 rounded-xl bg-primary text-white font-semibold shadow-lg hover:bg-blue-700 hover:shadow-primary/30 transition-all flex items-center justify-center"
            >
